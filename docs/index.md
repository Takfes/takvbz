<p align="center">
  <img width="600" src="static/takvbz.svg">
...
- AI-assisted development with [MCP (Model Context Protocol)](features/mcp.md) integration
- Pre-configured [VS Code settings](features/vscode.md) for Python development
- Optional [vibecoding workflows](features/vibecoding.md) for enhanced AI coding
